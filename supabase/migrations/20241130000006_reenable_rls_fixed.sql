-- Re-enable RLS with fixed policies that don't cause infinite recursion
...
DROP POLICY IF EXISTS "Users can update boards" ON public.boards;
DROP POLICY IF EXISTS "Users can delete boards" ON public.boards;
